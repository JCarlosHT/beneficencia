...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  ...
  <link rel="stylesheet" type="text/css" href="{{ URL::asset('vendors/select2/css/select2.min.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ URL::asset('vendors/bundle.css') }}" />
...
<script src="{{ URL::asset('vendors/dataTable/dataTables.bootstrap.min.js') }}"></script>
