...
for (var i = 0; i < buttons.length; i++) {
    ...
    buttons[i].classList.add('btn-' + color);
    }
  
  parent.classList.add('bg-gradient-' + color);
  header.classList.add('bg-gradient-' + color);
}
...
function sidebarType(a) {
  ...
  var sidebar = document.querySelector('.sidenav');
  var sidebar_head = document.querySelector('.sidenav-header');

  for (var i = 0; i < colors.length; i++) {
    sidebar.classList.remove(colors[i]);
  }
  for (var i = 0; i < colors.length; i++) {
    sidebar_head.classList.remove(colors[i]);
  }

  sidebar.classList.add(color);
  sidebar_head.classList.add(color);
  ...
  //   if (navbarBrandImg.includes('ssm_logo.png')) {
  //     var navbarBrandImgNew = navbarBrandImg.replace("ssm_logo", "ssm_logo"_white);
  //     navbarBrand.src = navbarBrandImgNew;
  //   }
  // } else {
  //   var navbarBrand = document.querySelector('.navbar-brand-img');
  //   var navbarBrandImg = navbarBrand.src;
  //   if (navbarBrandImg.includes('ssm_logo_white.png')) {
  //     var navbarBrandImgNew = navbarBrandImg.replace("ssm_logo_white", "ssm_logo");
  //     navbarBrand.src = navbarBrandImgNew;
  //   }
  // }
  ...
  //   if (navbarBrandImg.includes('ssm_logo.png')) {
  //     var navbarBrandImgNew = navbarBrandImg.replace("ssm_logo", "ssm_logo_white");
  //     navbarBrand.src = navbarBrandImgNew;
  //   }
  // }
}
